...
def add_collision_objects(planning_scene_monitor):
    ...
    with planning_scene_monitor.read_write() as scene:
        ...
        collision_object.header.frame_id = "limb1_1"
...
def main():
    ...
    panda_arm.set_start_state(configuration_name="random_valid")
    ...
    with planning_scene_monitor.read_only() as scene:
        ...
        robot_state.set_from_ik("arm", pose_goal, "hand")
    ...
    panda_arm.set_goal_state(configuration_name="random_valid")
    plan_and_execute(panda, panda_arm, logger, sleep_time=3.0)
