...
class DropObject(py_trees.behaviour.Behaviour):
    def __init__(self, name="Drop Object"):
        super(DropObject, self).__init__(name)
    ...
    def setup(self, node):
        self.node = node
        self.node.get_logger().info("Drop Object Setup")
        self.action_client= ActionClient(self.node,Pickup,"drop_object")
    ...
    def initialise(self):
        self.node.get_logger().info("Drop Object Initialize")
